...
默认数据文件为 `data/ctr_data_500k.csv`，需要包含：
...
```powershell
python main.py rank train --data-path data/ctr_data_500k.csv --epochs 5
```
...
```powershell
python main.py recall train --data-path data/ctr_data_500k.csv --epochs 6 --loss-type infonce
```
